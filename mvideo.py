...
# Фиксированные комиссии М.Видео из файла (applications-1new.xlsx)
COMMISSIONS = {
    "Автотовары": 20.5,
    "Аксессуары": 20.5,
    "Аксессуары для авто": 20.5,
    "Аксессуары для дома": 20.5,
    "Аксессуары для красоты": 20.5,
    "Аксессуары для кухни": 20.5,
    "Аксессуары для ТВ": 20.5,
    "Аксессуары для фото/видео": 20.5,
    "Аксессуары для электроники": 20.5,
    "Акустика": 20.5,
    "Аудио-видео техника": 20.5,
    "Бытовая химия": 20.5,
    "Гаджеты": 20.5,
    "Детские товары": 20.5,
    "Дом и сад": 20.5,
    "Инструменты": 20.5,
    "Канцтовары": 20.5,
    "Климатическая техника": 20.5,
    "Компьютерная техника": 15.5,
    "Компьютерные аксессуары": 15.5,
    "Красота и здоровье": 20.5,
    "Кухонная техника": 20.5,
    "Мебель": 20.5,
    "Ноутбуки и планшеты": 15.5,
    "Оргтехника и расходники": 15.5,
    "Освещение": 20.5,
    "Отдых и развлечения": 20.5,
    "Парфюмерия и косметика": 20.5,
    "Посуда": 20.5,
    "Смартфоны и связь": 15.5,
    "Спорт и активный отдых": 20.5,
    "Строительство и ремонт": 20.5,
    "ТВ и цифровое видео": 15.5,
    "Товары для взрослых": 20.5,
    "Товары для животных": 20.5,
    "Умный дом и безопасность": 17.5,
    "Фото- и видеокамеры": 15.5,
    "Цифровая техника": 15.5,
    "Электроника": 15.5,
}
...
def classify_size(length_cm: float, width_cm: float, height_cm: float, weight_kg: float) -> str:
...
def render(conn, get_ai_category, normalize_value, calc_tax, params: dict):
    ...
    with st.sidebar:
        st.divider()
        st.subheader("Статус комиссий")
        st.success(f"Загружено {len(COMMISSIONS)} категорий (фиксировано)")
        st.caption("Данные из актуального файла M.Video")
